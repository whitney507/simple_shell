...
extern char **environ;
/**
 * struct liststr - singly link list
 * @num: number field
 * @str: string
...
/**
 * struct passinfo - contain pseudo-args to pass to a func,
 * allowing an uniform prototype func pointer struct
 ...
 * @env: link list local copy environ
 * @environ: custom modified copy environ from LL env
...
/**
 * struct builtin - contains builtin string related func
